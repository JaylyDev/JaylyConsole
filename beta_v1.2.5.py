# Information 
# Name: Jayly Console 
# Description: JaylyConsole.description 
# Authors: Aliom (on behalf of Jayly) 
# UUID: 836b6cfd-3e9b-45eb-bce9-ad5ac0ebacd5
# Version: 1.3 
    ...
    if loading == 25:
        ...
        if loading == 50:
            ...
            if loading == 75:
                ...
                if loading == 100:
                    for cooldown in range(0, 10 + 1, 1):
                        print("Installing Developer Mode")
                else:
                    print("")
...
for loading in range(0, 150 + 1, 1):
    if loading == 25:
        ...
        if loading == 50:
            for cooldown in range(0, 10 + 1, 1):
                print("Installing User Service")	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
        else:
            if loading == 75:
                for cooldown in range(0, 10 + 1, 1):
                ...
                if loading == 100:
                    for cooldown in range(0, 10 + 1, 1):
                        print("Installing Developer Mode")	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                else:
                    print("")
print("Hello, " + username)
print("Unlocking document infomations")
            ...
            if selector == "/play 8ball":
                ...
                if selector == "/play rps":
                    ...
                    if selector == "/script python.beta-testing.miscellaneous.release_v1.2.1":
                        ...
                        if username == "	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub":
                                ...
                                if scriptSelector == "/script developer.program.test_in_python_1":
                                        ...
                                        if scriptSelector == "/script developer.program.test_in_python_2":
                                            ...
                                            if scriptSelector == "/script developer.program.test_in_python_3":
                                                ...
                                                # Selection is a decision within a computer program when the program decides what to do next based on the results of an event. In Console, we implement Selection using an if diamond.
                                                #2. Create a new flowchart in Console that tells the user whether they should wear shorts or not. First, ask the user for the current temperature. If the temperature is greater than 20 then tell them to wear shorts, otherwise tell them not to wear shorts.
                        ...
                        if selector == "/stop":
                            ...
                            if selector == "/script":
                                selected = 0
                                if username == "	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub":
                                    print("One 'Developer Command' is available for account '	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub'.")
                                    print("1. '/script python.beta-testing.miscellaneous.release_v1.2.1'")
                                else:
                                    print("Network Error")
                                    print("You do not have permission to access \\Aliom Console\Release\v1.2.3\data\script. Contact the developer to request access.")
                            else:
...
#                                                           print("Invalid Input.")
                                        ...
                                        selected = 0
                                        # Remember to reformat the codes
                                else:
                                    print("Invalid Input")
                                    selected = 0
                                    # Remember to reformat the codes
