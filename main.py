import random   #Function installation

random.seed()   #Prepare random number generator

for loading in range(0, 150 + 1, 1):
    if loading == 25:
        for cooldown in range(0, 10 + 1, 1):
            print("Loading")	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
    else:
        if loading == 50:
            for cooldown in range(0, 10 + 1, 1):
                print("Loading")	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
...
print("Welcome to Jayly's Console")
while True:    #This simulates a Do Loop
    print("Please enter the username to open this document")
    loginstatus = "0"
    username = input()
    if username == "username":
        ...
        if username == "vUrUewQ8GJtHsXmm":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
            while True:    #This simulates a Do Loop
                print("Please enter the password to open this document")
                passwordstatus = "0"
                password = input()
                if password == "RPpmYvU3KM8K8MZT":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                    print("Correct Password")
                    print("Hello, " + username)
                    print("Unlocking document infomations")
                    passwordstatus = "1"
            ...
            if username == "stg2MdjSdgBkykBV":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                while True:    #This simulates a Do Loop
                    print("Please enter the password to open this document")
                    passwordstatus = "0"
                    password = input()
                    if password == "mE7MJRYQLr6YYU4M":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                        print("Correct Password")
                        print("Hello, " + username)
                        print("Unlocking document infomations")
                        passwordstatus = "1"
                ...
                if username == "Dee4mEgpGgMbJaTW":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                    while True:    #This simulates a Do Loop
                        print("Please enter the password to open this document")
                        passwordstatus = "0"
                        password = input()
                        if password == "t6xJhXjtHzzzzPKp":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                            print("Correct Password")
                            print("Hello, " + username)
                            print("Unlocking document infomations")
                            passwordstatus = "1"
                    ...
                    if username == "gz4Nw8CH9bDuDdPz":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                        while True:    #This simulates a Do Loop
                            print("Please enter the password to open this document")
                            passwordstatus = "0"
                            password = input()
                            if password == "GNC93FVq5B24UjQm":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                                print("Correct Password")
                                print("Hello, " + username)
                                print("Unlocking document infomations")
                                passwordstatus = "1"
...
for loading in range(0, 150 + 1, 1):
    if loading == 25:
        for cooldown in range(0, 10 + 1, 1):
            print("Applying User data")	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
    else:
        if loading == 50:
            for cooldown in range(0, 10 + 1, 1):
                print("Applying User Settings")	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
        else:
            if loading == 75:
                for cooldown in range(0, 10 + 1, 1):
                    print("Applying User applications")	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
            else:
                if loading == 100:
                    for cooldown in range(0, 10 + 1, 1):
                        print("Preparing")	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                else:
                    print("")
print("Hello, " + username)
print("Unlocking document infomations")
...
while True:    #This simulates a Do Loop
    ...
    print("Type '/submissions' to check out your custom programs.")
        ...
        if selector == "/play trivia":
            ...
            if selector == "/play 8ball":
                ...
                if selector == "/play rps":
                    ...
                    if selector == "/submissions":
                        selected = 0
                        if username == "LmcTDTpnacr8GFtb":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                            print("You have 2 submissions on this account:")
                            print("1. Developer Mode: Type '/download developer_mode' to install your application.")
                            print("2. Distance Target Equation: Type '/download dist_target_cal' to install your application.")
                            ...
                            if installation == "/download developer_mode": 
                                for downloading in range(0, 1 + 1, 1):
                                    if downloading == 0:
                                        ...
                                        print("Type '/use developer_mode' to activate 'Developer Mode'")
                                        useCustomProgram = input()
                                        if useCustomProgram == "/use developer_mode":
                                        # Information 
                                        # Custom Program Name: Developer Mode
                                        # Custom Program Description: A Program for the developer 
                                        # Custom Program Authors: Jayly
                                        # Custom Program UUID: 8ed008b1-6f87-46e5-8df3-3825ed97f067
                                        # Custom Program Version: v1.1
                                        # Custom Program Last Modified Date: 3/12/2020
                                        # Custom Program Trusted By: Jayly 
                                        # Custom Program installed in: 30/11/2020
                                            if selector == "/script python.beta-testing.miscellaneous.release_v1.2.1":
                        
                                             if username == "akuYMxCaKarrUeEP":	# TrustedDeveloper has changed this line of code to censor all private infomations it contains before releasing on GitHub
                                                ...
                                                selected = 0
                                                print("This program has activated 'Developer Mode' by " + str(username) + ".")
                                                ...
                                                if scriptPassword == "4ebec206-b475-43e7-b92a-36c6ce228525":
                                                    ...
                                                    print("Type '/script developer.program.test_in_python_3' for Developer Program #3")
                                                    print("Type '/script developer.program.test_in_python_4' for Developer Program #4")
                                                    print("Type '/script developer.program.test_in_python_5' for Developer Program #5")
                                                    print("Type '/script developer.program.test_in_python_6' for Developer Program #6")
                                                    print("Type '/script developer.program.test_in_python_7' for Developer Program #7")
                                                    print("Type '/script developer.program.test_in_python_8' for Developer Program #8")
                                                    print("Type '/script developer.program.test_in_python_9' for Developer Program #9")
                                                    print("Type '/script developer.program.test_in_python_10' for Developer Program #10")
                                                    print("Type '/script developer.program.test_in_python_11' for Developer Program #11")
                                                    print("Type '/script developer.program.test_in_python_12' for Developer Program #12")
                                                    ...
                                                    if scriptSelector == "/script developer.program.test_in_python_1":
                                                        ...
                                                        print(answer)
                                                        selected = 0    # When the developer program is done it returns back to start page
                                                    else:
                                                    ...
                                                    print("Invalid script.python.beta-testing.miscellaneous.release_v1.2.1.developer_mode.password")
                                                    selected = 0
                                            else:
                                                print("Network Error")
                                                print("You do not have permission to access \\data\script. Contact the developer to request access.")
                            else:
                                if installation == "/download dist_target_cal": 
                                    for downloading in range(0, 1 + 1, 1):
                                        if downloading == 0:
                                            for ProgramSizeLeftToDownload in range(0, 2817 + 1, 1):
                                                print("Downloading Distance Target Equation. Downloaded " + str(ProgramSizeLeftToDownload) + " / 2817 Bytes.")
                                        else:
                                            print("You have downloaded 'Distance Target Equation'.")
                                            print("Type '/use dist_target_cal' to activate 'Distance Target Equation'")
                                            useCustomProgram = input()
                                            if useCustomProgram == "/use dist_target_cal":
                                                # Information 
                                                # Custom Program Name: Distance Target Equation
                                                # Custom Program Description: Aircraft Flying Object Distance Target Attitude Calculation.
                                                # Custom Program Authors: Jayly, of behalf of Lemmino for idea
                                                # Custom Program UUID: c07b9c10-241b-40ed-b50c-39f241da101b
                                                # Custom Program Version: v1.0
                                                # Custom Program Last Modified Date: 5/12/2020 
                                                # Custom Program Trusted By: Jayly 
                                                # Custom Program installed in: 6/12/2020
                                                import math
                            ...
                            print("You currenly do not have any submissions on your account. Contact the developer if you beileve this is an error.")
                            selected = 0
                    else:
                        if selector == "/stop":
                            ...
                            print("Invalid Input.")
                            selected = 0
#   Custom Program Format v1.0
#                                    else:
#                                        if username == "[Username]":
#                                            print("You have [submission_number] submission on this account:")
#                                            print("1. [Program Name]: Type '/download [program_name]' to install your application.")
#                                            print("Infomation about this user:")
#                                            print("Member since [username_joindate(hasRole == "Content Creator")]")
#                                            installation = input()
#                                            if installation == "/download developer_mode":
#                                                for downloading in range(0, 1 + 1, 1):
#                                                    if downloading == 0:
#                                                        for ProgramSizeLeftToDownload in range(0, [ProgramFileSizeToDownload] + 1, 1):
#                                                            print("Downloading Developer Mode. Downloaded " + str(ProgramSizeLeftToDownload) + " / [ProgramFileSizeToDownload Bytes.")
#                                                    else:
#                                                        print("You have downloaded [Program Name].")
#                                                        print("Type '[/use [program_name] command]' to activate [Program Name]")
#                                                        selected = 0
#                                                        useCustomProgram = input()
#                                                        if useCustomProgram == "[program_name]":
#                                                           # Information 
